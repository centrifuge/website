...
const ProvidedFunctionality = ({ functionality, img }) => (
  <Box direction="column" gap="large">
    ...
    <Box>
      <FunctionalityInfo
        title={
          functionality.functionality.contentAST.content[0].content[0].value
        }
        subtitle={
          functionality.functionality.contentAST.content[1].content[0].value
        }
        heading="3"
      />
    </Box>
              ...
              <React.Fragment key={index}>
                ...
                <Column mobileSpaced span={{ medium: 5, large: 3 }}>
                  <FunctionalityInfo
                    ...
                    subtitle={
                      block.content.contentAST.content[1].content[0].value
                    }
                    heading="3"
                  />
                </Column>
...
const ImageGetStartedSub = ({ src }) => (
  <Box align="center" style={{ marginTop: 50, marginBottom: 50 }}>
    <Image style={{ width: "80%", maxWidth: 1184 }} src={src} alt={"image"} />
  </Box>
);
export {
  FunctionalityInfo,
