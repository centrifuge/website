...
// Safari expects a start and end keyframe
const rotate = keyframes`
 0% { transform: rotate(0deg) }
 100% { transform: rotate(360deg) }
`

const Group = styled.g<{ animate: boolean }>`
  transform-origin: 50%;
...
const Path = styled.path<{ stagger: number; animate: boolean }>`
  transform-origin: 50%;
...
export function Swirl({ animate = false }: SwirlProps) {
